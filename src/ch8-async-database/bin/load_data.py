...
import infra.data.db_session as db_session
from app.models.Package import Package
from app.models.Release import Release
from app.models.User import User
from web.config import BASE_PATH, DATABASE_FILEPATH

def main():
    db_session.global_init(DATABASE_FILEPATH)
...
def do_load_files() -> List[dict]:
    data_path = Path(BASE_PATH.parent.parent.parent, 'data', 'pypi-top-100')
